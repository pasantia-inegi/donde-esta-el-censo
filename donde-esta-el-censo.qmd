...
- Tabla 1: **comunas**
  ...
  - Columna **geometry** contiene perímetros de comunas (en formato binario), usados para dibujar el contorno comunal mostrado en la aplicación.
:::
...
- Tabla 2: **perimeters_arc**
  ...
  - Cada fila contiene una geometría que incluye los multi-polígonos obtenidos agrupando Manzents por ARC y ciclo censal.
  - **Optimización I**: permite hacer más ligeras las consultas a la BBDD y reducir la cantidad de geometrías que la aplicación debe plotear. 
...
- Tabla 3: **perimeters_arc_ciclo**
  ...
  - **Optimización II**: aplicada a comunas con un gran número de ARCs (>300). Esto permite reducir aún más la latencia de la aplicación al consultar la BBDD y plotear las geometrías. 
    - Nació como medida de contención ante la alta demanda que ha tenido la aplicación.
:::
